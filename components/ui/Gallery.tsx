  ...
  return (
    <div className={cn(reverse && "lg:order-last")}>
      ...
      <button
        ...
        className="group relative block aspect-[4/3] w-full overflow-hidden border border-surface-200"
      >
        <Image
          src={cover}
          alt={alt}
        ...
        />
        <span className="absolute bottom-3 right-3 flex items-center gap-1.5 bg-ink-950/80 px-3 py-1.5 text-xs font-medium text-white">
        ...
        <div className="mt-3 grid grid-cols-3 gap-3">
          {thumbs.map((src, i) => (
            <button
              ...
              className="relative aspect-[4/3] overflow-hidden border border-surface-200 transition hover:opacity-80"
            >
              <Image
                src={src}
                alt={`${alt} — foto ${i + 2}`}
